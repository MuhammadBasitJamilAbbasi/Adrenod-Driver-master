...
import 'package:adrenod_driver/pages/navDrawer/nav_drawer.dart';
  ...
  getLocs() async {
    ...
    if (permission == geolocator.LocationPermission.denied ||
      ...
      if (serviceEnabled == true) {
        ...
        await getBytesFromAsset('assets/images/rickswa.png', 60);
        ...
        if (mounted) {
          setState(() {
            ...
            //hashir sab chnging ider huni icon dependent
            if (myMarkers.isEmpty && userDetails['role'] != 'owner') {
              if (userDetails['vehicle_type_icon_for'] == 'taxi') {
                myMarkers = [
                  Marker(
                      ...
                      rotation: heading,
                      position: center,
                      icon: (userDetails['vehicle_type_icon_for'] ==
                          'taxi')
                          ? pinLocationIcon
                          : pinLocationIcon3,
              ...
              else if (userDetails['vehicle_type_icon_for'] == 'motor_bike') {
                myMarkers = [
                  Marker(
                      markerId: const MarkerId('1'),
                      rotation: heading,
                ...
                if(userDetails['vehicle_type_icon_for'] == 'taxi') {
                  myMarkers.add(
                    Marker(
                        ...
                        rotation: heading,
                        position: center,
                        icon: (userDetails['vehicle_type_icon_for'] == 'taxi')
                            ? pinLocationIcon2
                            : pinLocationIcon,
                        anchor: const Offset(0.5, 0.5)
                    ),
                  ...
                  myMarkers.add(
                    Marker(
                        ...
                        rotation: heading,
                        position: center,
                        icon: (userDetails['vehicle_type_icon_for'] == 'truck')
                            ? pinLocationIcon3
                            : pinLocationIcon,
                        anchor: const Offset(0.5, 0.5)
                    ),
                ...
                if (driverReq['is_completed'] != 1) {
                  if (myMarkers
                    ...
                    Future.delayed(const Duration(milliseconds: 2000), () {
                      // _pickAnimateDone = true;
                      addPickDropMarker();
                      if(  driverReq['drop_address']!=0 && driverReq['pick_address']!=0)
                      {

                        Text txt = Text(  driverReq['drop_address'],);
                        // print(txt.data);
                        Text txt1 = Text(  driverReq['pick_address'],);
                        // print(txt.data);
                        String? dropoutuser=txt1.data;
                        String? pickupuser=txt.data;
                        // getLatLang(UserCureentLocation!, dropoutuser!).then((value)

                        getLatLang(pickupuser!, dropoutuser!).then((value)
                        {
                          // print(value);
                          valueDistance=value;
                        });
                                                                    ...
                                                                    ? (driverReq['accepted_at'] ==
                                                                        ...
                                                                        child: SingleChildScrollView(
                                                                              ...
                                                                              Row(
                                                                                children: [
                                                                                  Text(
                                                                                      languages[choosenLanguage]['text_Dsitance'],
                                                                                      style: GoogleFonts
                                                                                          .roboto(fontWeight:  FontWeight
                                                                                          .bold,
                                                                                          fontSize: media
                                                                                              .width *
                                                                                              thirteen,
                                                                                  ...
                                                                                  TextButton(
                                                                                    ...
                                                                                    onPressed: null,
                                                                                    child:Text(valueDistance.toString()+"Km"),
                                                                                  ),

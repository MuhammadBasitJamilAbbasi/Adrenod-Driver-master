...
import 'package:adrenod_driver/pages/login/otp_page.dart';
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                              border:
                                  ...
                                  top:BorderSide(color: underline),
                                  right: BorderSide(color: underline),
                                  left: BorderSide(color: underline))),
                          child: Row(
                            children: [
                              InkWell(
                                onTap: () async {
                            ...
                            SizedBox(
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () {
                                      openBrowser('https://adrenod.com/terms');
                                    },
                                    child: Text(

...
import 'package:adrenod_driver/pages/loadingPage/loadingpage.dart';
import 'package:adrenod_driver/pages/login/get_started.dart';
...
import 'package:adrenod_driver/pages/onTripPage/review_page.dart';
import 'package:adrenod_driver/pages/vehicleInformations/referral_code.dart';
import 'package:adrenod_driver/pages/vehicleInformations/service_area.dart';
import 'package:adrenod_driver/pages/vehicleInformations/upload_docs.dart';
import 'package:adrenod_driver/pages/vehicleInformations/vehicle_color.dart';
import 'package:adrenod_driver/pages/vehicleInformations/vehicle_make.dart';
import 'package:adrenod_driver/pages/vehicleInformations/vehicle_model.dart';
import 'package:adrenod_driver/pages/vehicleInformations/vehicle_number.dart';
import 'package:adrenod_driver/pages/vehicleInformations/vehicle_type.dart';
import 'package:http/http.dart' as http;
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:firebase_messaging/firebase_messaging.dart';
import 'package:adrenod_driver/pages/vehicleInformations/vehicle_year.dart';
...
getVehicleMake() async {
  ...
  try {
    final response = await http.get(
      Uri.parse('${url}api/v1/common/car/makes?vehicle_type=$myVehicleIconFor'),
    );
        ...
        foregroundNotificationConfig:
          ...
          notificationText:
              "Adrenod"
                  ...
                  ""
                  ""
                  " will continue to receive your location in background",
